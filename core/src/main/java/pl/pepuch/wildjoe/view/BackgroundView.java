...
public class BackgroundView extends StaticView {
	...
	public BackgroundView(BackgroundModel model) {
		...
		backgroundLayer = addLayer(image, xPos, yPos);
		...
		addLayer(image, xPos, yPos).setDepth(-3);
		// small stone
	...
	private Layer addLayer(Image image, float x, float y) {
